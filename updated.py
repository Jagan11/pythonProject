...
fmongo = '/Users/jd/Downloads/output_mongo' + str(now) + '.xlsx'
fmysql = '/Users/jd/Downloads/output_mysql' + str(now) + '.xlsx'
...
df.to_excel('/Users/jd/Downloads/output_final' + str(now) + '.xlsx')
print(df)